...
const DEMO_USERS = [
  { phone: '79001234567', password: 'client123', name: 'Александр Петров', role: 'client' },
  { phone: '79132034981', password: '249322', name: 'Администратор', role: 'admin' },
];
...
export default function AuthPage({ onLogin, onNavigate }: AuthPageProps) {
  ...
  const handleLogin = () => {
    ...
    const user = DEMO_USERS.find(u => u.phone === digits && u.password === password);
    if (user) {
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          <button onClick={() => onNavigate('home')} className="inline-flex flex-col items-center gap-2">
            ...
            <div className="font-display text-2xl font-bold text-gray-900 tracking-wide">АВТОСПЕКТР</div>
          </button>
          ...
          <div className="p-8">
            ...
            <div className="space-y-4">
              {mode === 'register' && (
                <div>
                  ...
                  <div className="relative">
                    <Icon name="User" size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400" />
                    <input
                      type="text"
                      value={name}
              ...
              <div>
                ...
                <div className="relative">
                  <Icon name="Phone" size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    type="tel"
                    value={phone}
              ...
              <div>
                ...
                <div className="relative">
                  <Icon name="Lock" size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    type="password"
                    value={password}
